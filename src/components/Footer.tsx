      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start justify-between gap-6 sm:gap-8 pb-6 sm:pb-8 border-b border-gray-800">
          ...
          <div className="flex gap-4 sm:gap-6 md:gap-8 flex-shrink-0 w-full sm:w-auto justify-between sm:justify-start">
            {/* About Column */}
            <div>
              <a href="/about" className="text-white hover:text-coral font-bold text-sm sm:text-base transition-colors">
                About
              </a>
            </div>
            ...
            <div>
              <h3 className="text-white font-bold text-sm sm:text-base leading-tight mb-4">Work</h3>
            ...
            {/* Clients Column */}
            <div>
              <a href="/#clients" className="text-white hover:text-coral font-bold text-sm sm:text-base transition-colors">
                Clients
              </a>
            </div>
            ...
            {/* Contact Column */}
            <div>
              <a href="/contact" className="text-white hover:text-coral font-bold text-sm sm:text-base transition-colors">
                Contact
              </a>
            </div>
          </div>
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
          ...
          <div className="text-center sm:text-left">
            <h2 className="text-white font-bold text-2xl sm:text-3xl mb-1">CS CORP</h2>
